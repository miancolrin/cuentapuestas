...
Debemos tener el fichero del registro en el mismo directorio que el ejecutable
.exe de este programa, si no no seremos capaces de abrirlo. El fichero del registro
se puede copiar, mover, compartir...
